...
import "./lodgingscard.scss"


export default function LodgingsCard({option, type, name, setBody, body, setVacation, setRemovedItemMsg, setReturnToVacay}) {
  const [liked, setLiked] = useState(false);
  const [likeCount, setLikeCount] = useState(option.likes);


  function handleDelete (e) {
    console.log("I was clicked to delete lodging")
    console.log(option)
